package com.openapifuse.generated.jsonplaceholder.jsonplaceholder.controller;

import com.openapifuse.generated.jsonplaceholder.jsonplaceholder.client.TargetApiClient;
import com.openapifuse.generated.jsonplaceholder.client.TargetApiResponse;
import com.openapifuse.generated.jsonplaceholder.jsonplaceholder.mapper.JsonplaceholderMapper;
import com.openapifuse.generated.jsonplaceholder.jsonplaceholder.mapper.Targetoperationjsonplaceholder;
import com.openapifuse.generated.jsonplaceholder.jsonplaceholder.mapper.Targetoperationjsonplaceholder;
...
public class JsonplaceholderController {
    ...
    private final JsonplaceholderMapper mapper = new JsonplaceholderMapper();
    private final TargetApiClient targetApiClient;
    private final ObjectMapper objectMapper;

    public JsonplaceholderController(@Qualifier("jsonplaceholderTargetApiClient") TargetApiClient targetApiClient, ObjectMapper objectMapper) {
        this.targetApiClient = targetApiClient;
        this.objectMapper = objectMapper;
    }

    @PostMapping("/jsonplaceholder/transform")
